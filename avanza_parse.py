...
def getOutput(res):
    ...
    msg += 'Day revenue: {0:n} {1}. '.format(res['totalValueTraded'], res['orderBookCurrency'])
    msg += 'Shareholders: {0:n}. '.format(res['numOwners'])
    msg += 'Net Worth: {0:n}MSEK. (Updated: {1}) '.format(res['networth'], res['lastUpdate'])
    return msg
